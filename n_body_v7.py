...
perturb_1 = np.linspace(-0.03,0.03,5)
...
plt.pcolormesh(perturb_1,perturb_2,np.tile(shape_value,(2,1)),shading='nearest',cmap='Greens')
plt.show()
#-0.02692308 seemed stableish but not for as long as originally thought